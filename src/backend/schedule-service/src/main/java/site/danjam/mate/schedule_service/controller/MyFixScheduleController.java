...
public class MyFixScheduleController {
    ...
    @MethodDescription(description = "고정 시간표 생성하기")
    ...
    @MethodDescription(description = "고정 시간표 조회하기")
    ...
    @MethodDescription(description = "고정 시간표 수정하기")
    ...
    @MethodDescription(description = "고정 시간표 삭제하기")
